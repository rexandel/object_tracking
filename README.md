...
| `dribbling_ball` | Теряет мяч, переключается на похожий объект | Полностью теряет объект | Теряет мяч, переключается на похожий объект | **CSRT** |
...
- В `dribbling_ball` вместо полной потери объекта собственная реализация переключается на похожий объект
- В `street_walking` позволяет сделать выделяемую область меньшего размера, но при этом отслеживание объекта происходит корректно

### Результаты работы собственной реализации KCF

<div style="display: flex; gap: 0;">
  <img src="https://github.com/user-attachments/assets/84d92089-ad62-4a35-b52b-4c778887d186" width="250" style="object-fit: cover;">
  <img src="https://github.com/user-attachments/assets/aba96230-6f2f-4aae-9cca-0540c34c4e05" width="250" style="object-fit: cover;">
  <img src="https://github.com/user-attachments/assets/9dc2ee8e-a614-49d3-9935-96f92b4d5620" width="250" style="object-fit: cover;">
</div>
